        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text('Classify this transaction into into a particular category', style: TextStyle( color: Colors.white, fontSize: 18.0 ),),
            ],
        ),
      ),
    );
  ...
  Widget _bottomNavigationBar(context){
    ...
    return new Theme(
      data: Theme.of(context).copyWith(
        ...
        textTheme: Theme.of(context).textTheme //cambiar color de icons navegacion
